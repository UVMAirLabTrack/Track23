...
class FourWayVisualizer(Node):
    ...
    def publish_marker(self):
        ...
        marker_msg.mesh_resource = os.path.join(get_package_share_directory(self.package_name),  'markers', 'light.stl')#os.path.join(worlds_folder_path,'worlds' 'markers', 'light.stl')  # Update with your mesh file
