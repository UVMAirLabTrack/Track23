...
def main(args=None):
    ...
    publisher = node.create_publisher(Int32MultiArray, 'train_crossing_state', 10)
    ...
    file_path = os.path.join(parent_folder, 'control', 'train_states.txt')  # Specify the filename
